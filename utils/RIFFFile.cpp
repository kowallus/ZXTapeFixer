...
const TypeRecord extraTypes[numExtraTypes] = {
	{  (char*)"DISP",  (char*)"Display name" },
	{ (char*)"IARL", (char*)"Archival location" },
	{ (char*)"IART", (char*)"Artist" },
	{ (char*)"ICMS", (char*)"Commissioned" },
	{ (char*)"ICMT", (char*)"Comments" },
	{ (char*)"ICOP", (char*)"Copyright" },
	{ (char*)"ICRD", (char*)"Creation date" },
	{ (char*)"ICRP", (char*)"Cropped" },
	{ (char*)"IDIM", (char*)"Dimensions" },
	{ (char*)"IDPI", (char*)"Dots Per Inch" },
	{ (char*)"IENG", (char*)"Engineer" },
	{ (char*)"IGNR", (char*)"Genre" },
	{ (char*)"IKEY", (char*)"Keywords" },
	{ (char*)"ILGT", (char*)"Lightness" },
	{ (char*)"IMED", (char*)"Medium" },
	{ (char*)"INAM", (char*)"Name" },
	{ (char*)"IPLT", (char*)"Palette Setting" },
	{ (char*)"IPRD", (char*)"Product" },
	{ (char*)"ISBJ", (char*)"Subject" },
	{ (char*)"ISFT", (char*)"Software" },
	{ (char*)"ISHP", (char*)"Sharpness" },
	{ (char*)"ISRC", (char*)"Source" },
	{ (char*)"ISRF", (char*)"Source Form" },
	{ (char*)"ITCH", (char*)"Technician" },
};
